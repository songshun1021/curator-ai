        ...
        {step === 0 ? (
          <div className="flex min-h-[620px] items-center">
            <div className="grid w-full gap-6 lg:grid-cols-[0.52fr_0.48fr]">
              <div className="glass-subpanel border-white/70 p-6 md:p-7">
                <div className="text-[11px] uppercase tracking-[0.28em] text-text-subtle">{ONBOARDING_COPY.step1Eyebrow}</div>
                <h1 className="mt-3 text-[28px] font-semibold tracking-tight text-text-title">{ONBOARDING_COPY.step1Title}</h1>
                <p className="mt-3 text-[15px] leading-7 text-text-muted">{ONBOARDING_COPY.step1Subtitle}</p>
                <div className="mt-8 flex items-center gap-3">
                  <button type="button" className="curator-button-primary curator-button-sm" onClick={() => setStep(1)}>
                    下一步
                    <ArrowRight size={14} />
                  </button>
                  <button type="button" className="curator-button-ghost curator-button-sm" onClick={onSkip}>
              ...
              <div className="relative min-h-[520px]">
                <article className="glass-subpanel absolute right-8 top-3 w-[56%] border-white/70 p-4 shadow-[0_18px_40px_rgba(15,23,42,0.08)]">
                  <div className="flex h-[248px] items-center justify-center overflow-hidden rounded-[14px] border border-white/70 bg-white/80 p-3">
                    <img
                      src={ONBOARDING_SCREENSHOTS[0].imageSrc}
                      alt={ONBOARDING_SCREENSHOTS[0].title}
                      className="max-h-full w-full object-contain object-center"
                    />
                  </div>
                  <div className="mt-3">
                    <div className="text-[11px] uppercase tracking-[0.22em] text-zinc-400">{ONBOARDING_SCREENSHOTS[0].eyebrow}</div>
                    <div className="mt-1 text-sm font-semibold text-zinc-800">{ONBOARDING_SCREENSHOTS[0].title}</div>
                    <p className="mt-1 text-xs leading-5 text-zinc-500">{ONBOARDING_SCREENSHOTS[0].description}</p>
                  </div>
                </article>

                <article className="glass-subpanel absolute left-0 bottom-4 w-[43%] border-white/70 p-3 shadow-[0_14px_32px_rgba(15,23,42,0.08)]">
                  <div className="flex h-[168px] items-center justify-center overflow-hidden rounded-[12px] border border-white/70 bg-white/80 p-3">
                    <img
                      src={ONBOARDING_SCREENSHOTS[1].imageSrc}
                      alt={ONBOARDING_SCREENSHOTS[1].title}
                      className="max-h-full w-full object-contain object-center"
                    />
                  </div>
                  <div className="mt-3">
                    <div className="text-[11px] uppercase tracking-[0.22em] text-zinc-400">{ONBOARDING_SCREENSHOTS[1].eyebrow}</div>
                    <div className="mt-1 text-sm font-semibold text-zinc-800">{ONBOARDING_SCREENSHOTS[1].title}</div>
                    <p className="mt-1 text-xs leading-5 text-zinc-500">{ONBOARDING_SCREENSHOTS[1].description}</p>
                  </div>
                </article>

                <article className="glass-subpanel absolute right-0 bottom-0 w-[43%] border-white/70 p-3 shadow-[0_14px_32px_rgba(15,23,42,0.08)]">
                  <div className="flex h-[168px] items-center justify-center overflow-hidden rounded-[12px] border border-white/70 bg-white/80 p-3">
                    <img
                      src={ONBOARDING_SCREENSHOTS[2].imageSrc}
                      alt={ONBOARDING_SCREENSHOTS[2].title}
                      className="max-h-full w-full object-contain object-center"
                    />
                  </div>
                  <div className="mt-3">
                    <div className="text-[11px] uppercase tracking-[0.22em] text-zinc-400">{ONBOARDING_SCREENSHOTS[2].eyebrow}</div>
                    <div className="mt-1 text-sm font-semibold text-zinc-800">{ONBOARDING_SCREENSHOTS[2].title}</div>
                    <p className="mt-1 text-xs leading-5 text-zinc-500">{ONBOARDING_SCREENSHOTS[2].description}</p>
                  </div>
                </article>
              </div>
            </div>
          ...
          <div className="flex min-h-[620px] items-center">
            <div className="grid w-full gap-6 lg:grid-cols-[0.52fr_0.48fr]">
              <div className="glass-subpanel border-white/70 p-5">
                ...
                <div className="mt-8 flex items-center gap-3">
                  <button type="button" className="curator-button-primary curator-button-sm" onClick={() => setStep(2)}>
                    下一步
                    <ArrowRight size={14} />
                  </button>
                  <button type="button" className="curator-button-ghost curator-button-sm" onClick={() => setStep(2)}>
                    跳过
                  </button>
                </div>
              </div>
              ...
              <div className="grid gap-5">
                <div className="glass-subpanel border-white/70 p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-500">上传 PDF，整理主简历。</p>
                  <button
                    type="button"
                ...
                <div className="glass-subpanel border-white/70 p-5">
                  ...
                  <p className="mt-2 text-sm leading-6 text-zinc-500">先把目标岗位补完整。</p>
        ...
        {step === 2 ? (
          <div className="flex min-h-[620px] items-center">
            <div className="grid w-full gap-6 lg:grid-cols-[0.48fr_0.52fr]">
              ...
              <div className="glass-subpanel border-white/70 p-6">
                ...
                <div className="mt-6 space-y-3">
                  ...
                  <div className="rounded-[16px] border border-white/70 bg-white/72 px-4 py-3 text-sm text-zinc-700">生成匹配度分析</div>
                  <div className="rounded-[16px] border border-white/70 bg-white/72 px-4 py-3 text-sm text-zinc-700">生成 BOSS 文书</div>
                </div>
                <div className="mt-8 flex items-center gap-3">
                  <button type="button" className="curator-button-primary curator-button-sm" onClick={() => setStep(3)}>
                    下一步
                    <ArrowRight size={14} />
                  </button>
                  <button type="button" className="curator-button-ghost curator-button-sm" onClick={() => setStep(3)}>
                    跳过
                  </button>
                </div>
              </div>
          ...
          <div className="flex min-h-[620px] items-center">
            <div className="grid w-full gap-6 lg:grid-cols-[0.48fr_0.52fr]">
              ...
              <div className="glass-subpanel border-white/70 p-6">
                ...
                <div className="mt-6 rounded-[16px] border border-white/70 bg-white/72 p-4 text-sm text-zinc-700">
                  面后可自动生成反馈与下一轮改进点。
                </div>
                    ...
                    return (
                      <div key={label} className="flex items-center justify-between rounded-[16px] border border-white/70 bg-white/70 px-4 py-3">
                        ...
                        <div className="text-xs text-zinc-500">
                          {state === "done" ? "已完成" : state === "active" ? "处理中" : "等待中"}
                        </div>
                      </div>
                    );
                  })}
                ...
                <div className="mt-8 flex items-center gap-3">
                  {runState.completed ? (
                    <button type="button" className="curator-button-primary curator-button-sm" onClick={onComplete}>
                      进入工作台
                      <ArrowRight size={14} />
                    </button>
                  ) : (
                    <button
                      ...
                      onClick={() => void handleImportAndEnter()}
                    >
                      {runState.running ? "处理中..." : "进入工作台"}
                      <ArrowRight size={14} />
                    </button>
                  )}
                  <button type="button" className="curator-button-ghost curator-button-sm" onClick={onSkip} disabled={runState.running}>
                    跳过
                  </button>
                </div>
              </div>
